...
**status**: {@link ExportTaskStatusEnum} 是否完成，1 -> 完成, 0->处理中, -1 -> 出错

**type**: {@link ExportTaskTypeEnums} 导出类型
...
分页查询用户列表分页查询用户列表根据查询条件分页获取用户列表
...
根据ID获取用户详情获取用户详情根据用户ID获取用户详细信息
...
根据ID获取角色详情获取角色详情根据角色ID获取角色详细信息
...
获取部门列表数据复杂业务场景：需要查询和树形构建，调用Manager层获取部门列表获取所有部门数据，返回树形结构
...
创建部门复杂业务场景：需要业务逻辑验证和事务处理，调用Manager层创建部门创建新的部门
...
更新部门复杂业务场景：需要业务逻辑验证和事务处理，调用Manager层更新部门更新指定ID的部门
...
删除部门复杂业务场景：需要业务逻辑验证和事务处理，调用Manager层删除部门删除指定ID的部门
...
获取部门详情简单业务场景：获取单个实体，但需要DTO转换，调用Manager层获取部门详情根据ID获取部门详细信息
...
获取用户所有菜单复杂业务场景：需要多表查询和树形构建，调用Manager层获取用户菜单获取当前登录用户的所有可访问菜单，返回树形结构
...
获取用户权限菜单（前端路由格式）复杂业务场景：需要多表查询和树形构建，调用Manager层获取用户权限菜单获取当前登录用户的权限菜单，返回前端路由格式
...
获取菜单数据列表复杂业务场景：需要查询和树形构建，调用Manager层获取菜单列表获取所有菜单数据，返回树形结构
...
检查菜单名称是否存在复杂业务场景：需要业务逻辑验证，调用Manager层检查菜单名称检查菜单名称是否已存在
...
检查菜单路径是否存在复杂业务场景：需要业务逻辑验证，调用Manager层检查菜单路径检查菜单路径是否已存在
...
创建菜单复杂业务场景：需要业务逻辑验证和事务处理，调用Manager层创建菜单创建新的菜单
...
更新菜单复杂业务场景：需要业务逻辑验证和事务处理，调用Manager层更新菜单更新指定ID的菜单
...
删除菜单复杂业务场景：需要业务逻辑验证和事务处理，调用Manager层删除菜单删除指定ID的菜单
...
根据ID获取菜单详情简单业务场景：单表查询，直接调用Service层获取菜单详情根据ID获取菜单详细信息
...
灵活单条查询支持ID、app+stream、proxyKey等多种条件查询
...
单条记录删除支持ID、proxyKey、app+stream优先级删除策略
...
更新代理状态根据ID启用/禁用代理，status：1启用 0禁用
...
更新推流代理状态根据ID启用/禁用推流代理，status：1启用 0禁用
...
获取版本信息获取版本信息获取ZLMediaKit服务器的版本信息
...
获取API列表获取API列表获取ZLMediaKit服务器支持的所有API接口列表
...
获取网络线程负载获取网络线程负载获取ZLMediaKit服务器网络线程的负载情况
...
获取主要对象个数获取统计信息获取ZLMediaKit服务器主要对象的统计数量
...
获取后台线程负载获取后台线程负载获取ZLMediaKit服务器后台工作线程的负载情况
...
获取服务器配置获取服务器配置获取ZLMediaKit服务器的配置信息
...
设置服务器配置设置服务器配置修改ZLMediaKit服务器的配置参数
...
获取流列表获取流列表获取ZLMediaKit服务器中的媒体流列表
...
获取媒体流播放器列表获取媒体流播放器列表获取指定媒体流的播放器列表
...
广播webrtc datachannel消息广播WebRTC消息广播WebRTC datachannel消息
...
获取所有TcpSession列表获取TCP会话列表获取ZLMediaKit服务器中所有TCP连接会话的列表
...
断开tcp连接断开TCP连接根据会话ID断开指定的TCP连接
...
批量断开tcp连接批量断开TCP连接根据条件批量断开TCP连接
...
添加代理拉流添加代理拉流添加一个拉流代理，用于从外部拉取媒体流
...
添加推流代理添加推流代理添加一个推流代理，用于向外部推送媒体流
...
添加FFmpeg拉流代理添加FFmpeg拉流代理添加一个FFmpeg拉流代理，用于从外部拉取媒体流
...
关闭FFmpeg拉流代理关闭FFmpeg拉流代理根据代理key关闭指定的FFmpeg拉流代理
...
获取录制文件列表获取录制文件列表获取指定媒体流的录制文件列表
...
获取截图URL - 返回可访问的URL路径获取截图URL获取指定媒体流的截图并返回可访问的URL
...
获取rtp推流信息获取RTP推流信息根据流ID获取RTP推流的详细信息
...
创建RTP服务器创建RTP服务器创建一个RTP服务器用于接收RTP推流
...
创建多路复用RTP服务器创建多路复用RTP服务器创建一个多路复用RTP服务器
...
关闭RTP服务器关闭RTP服务器根据流ID关闭指定的RTP服务器
...
更新RTP服务器过滤SSRC更新RTP服务器SSRC更新RTP服务器的过滤SSRC
...
暂停RTP超时检查暂停RTP超时检查暂停指定RTP服务器的超时检查
...
恢复RTP超时检查恢复RTP超时检查恢复指定RTP服务器的超时检查
...
获取RTP服务器列表获取RTP服务器列表获取所有正在运行的RTP服务器列表
...
开始tcp passive被动发送rtp开始被动发送RTP开始TCP passive模式被动发送RTP流
...
指定节点获取版本信息指定节点获取版本信息获取指定ZLM节点的版本信息
...
指定节点获取流列表指定节点获取流列表获取指定ZLM节点中的媒体流列表
...
获取所有节点列表获取所有节点列表获取当前配置的所有ZLM节点信息
...
| 名称 | 类型 | 必选 | 约束 | 中文名 | 说明 |
| --- | --- | --- | --- | --- | --- |
| _anonymous_ | [[ZlmNode](#schemazlmnode)] | false | none |  | 获取成功 |
...
| 名称 | 位置 | 类型                                    | 必选 | 说明 |
| ---- | ---- | --------------------------------------- | ---- | ---- |
| body | body | [LabRegisterReq](#schemalabregisterreq) | 否   | none |
...
POST /api/v1/lab/client/unregister
...
POST /api/v1/lab/client/keepalive
...
POST /api/v1/lab/client/keepalive/auto
...
| 名称 | 位置 | 类型 | 必选 | 说明 |
| --- | --- | --- | --- | --- |
| body | body | [LabKeepaliveAutoReq](#schemalabkeepaliveautoreq) | 否 | none |
...
POST /api/v1/lab/client/catalog/push
...
| 名称 | 位置 | 类型                                          | 必选 | 说明 |
| ---- | ---- | --------------------------------------------- | ---- | ---- |
| body | body | [LabCatalogPushReq](#schemalabcatalogpushreq) | 否   | none |
...
POST /api/v1/lab/client/device-info/push
...
| 名称 | 位置 | 类型 | 必选 | 说明 |
| --- | --- | --- | --- | --- |
| body | body | [LabDeviceInfoPushReq](#schemalabdeviceinfopushreq) | 否 | none |
...
POST /api/v1/lab/client/alarm/push
...
| 名称 | 位置 | 类型                                      | 必选 | 说明 |
| ---- | ---- | ----------------------------------------- | ---- | ---- |
| body | body | [LabAlarmPushReq](#schemalabalarmpushreq) | 否   | none |
...
## GET 返回当前 Lab 身份与端口配置

GET /api/v1/lab/client/config
...
<a id="schemaversion"></a> <a id="schema_Version"></a> <a id="tocSversion"></a> <a id="tocsversion"></a>
...
<a id="schemahookresult"></a> <a id="schema_HookResult"></a> <a id="tocShookresult"></a> <a id="tocshookresult"></a>
...
<a id="schemaajaxresultmedianodevo"></a> <a id="schema_AjaxResultMediaNodeVO"></a> <a id="tocSajaxresultmedianodevo"></a> <a id="tocsajaxresultmedianodevo"></a>
...
<a id="schemaserverresponseversion"></a> <a id="schema_ServerResponseVersion"></a> <a id="tocSserverresponseversion"></a> <a id="tocsserverresponseversion"></a>
...
<a id="schemakeeplivedata"></a> <a id="schema_KeepLiveData"></a> <a id="tocSkeeplivedata"></a> <a id="tocskeeplivedata"></a>
...
<a id="schemaajaxresultlistmedianodevo"></a> <a id="schema_AjaxResultListMediaNodeVO"></a> <a id="tocSajaxresultlistmedianodevo"></a> <a id="tocsajaxresultlistmedianodevo"></a>
...
<a id="schemaserverresponseliststring"></a> <a id="schema_ServerResponseListString"></a> <a id="tocSserverresponseliststring"></a> <a id="tocsserverresponseliststring"></a>
...
<a id="schemaonserverkeepalivehookparam"></a> <a id="schema_OnServerKeepaliveHookParam"></a> <a id="tocSonserverkeepalivehookparam"></a> <a id="tocsonserverkeepalivehookparam"></a>
...
<a id="schemaajaxresultmedianodelistresp"></a> <a id="schema_AjaxResultMediaNodeListResp"></a> <a id="tocSajaxresultmedianodelistresp"></a> <a id="tocsajaxresultmedianodelistresp"></a>
...
<a id="schemaajaxresult"></a> <a id="schema_AjaxResult"></a> <a id="tocSajaxresult"></a> <a id="tocsajaxresult"></a>
...
<a id="schemathreadload"></a> <a id="schema_ThreadLoad"></a> <a id="tocSthreadload"></a> <a id="tocsthreadload"></a>
...
<a id="schemaonplayhookparam"></a> <a id="schema_OnPlayHookParam"></a> <a id="tocSonplayhookparam"></a> <a id="tocsonplayhookparam"></a>
...
<a id="schemaserverresponselistthreadload"></a> <a id="schema_ServerResponseListThreadLoad"></a> <a id="tocSserverresponselistthreadload"></a> <a id="tocsserverresponselistthreadload"></a>
...
<a id="schemamedianodecreatereq"></a> <a id="schema_MediaNodeCreateReq"></a> <a id="tocSmedianodecreatereq"></a> <a id="tocsmedianodecreatereq"></a>
...
<a id="schemahookresultforonpublish"></a> <a id="schema_HookResultForOnPublish"></a> <a id="tocShookresultforonpublish"></a> <a id="tocshookresultforonpublish"></a>
...
<a id="schemaimportantobjectnum"></a> <a id="schema_ImportantObjectNum"></a> <a id="tocSimportantobjectnum"></a> <a id="tocsimportantobjectnum"></a>
...
<a id="schemamedianodeupdatereq"></a> <a id="schema_MediaNodeUpdateReq"></a> <a id="tocSmedianodeupdatereq"></a> <a id="tocsmedianodeupdatereq"></a>
...
<a id="schemaonpublishhookparam"></a> <a id="schema_OnPublishHookParam"></a> <a id="tocSonpublishhookparam"></a> <a id="tocsonpublishhookparam"></a>
...
<a id="schemaserverresponseimportantobjectnum"></a> <a id="schema_ServerResponseImportantObjectNum"></a> <a id="tocSserverresponseimportantobjectnum"></a> <a id="tocsserverresponseimportantobjectnum"></a>
...
<a id="schemamedianodedo"></a> <a id="schema_MediaNodeDO"></a> <a id="tocSmedianodedo"></a> <a id="tocsmedianodedo"></a>
...
<a id="schemaservernodeconfig"></a> <a id="schema_ServerNodeConfig"></a> <a id="tocSservernodeconfig"></a> <a id="tocsservernodeconfig"></a>
...
<a id="schemaajaxresultmapobject"></a> <a id="schema_AjaxResultMapObject"></a> <a id="tocSajaxresultmapobject"></a> <a id="tocsajaxresultmapobject"></a>
...
<a id="schemaserverresponseservernodeconfig"></a> <a id="schema_ServerResponseServerNodeConfig"></a> <a id="tocSserverresponseservernodeconfig"></a> <a id="tocsserverresponseservernodeconfig"></a>
...
<a id="schemaserverresponselistservernodeconfig"></a> <a id="schema_ServerResponseListServerNodeConfig"></a> <a id="tocSserverresponselistservernodeconfig"></a> <a id="tocsserverresponselistservernodeconfig"></a>
...
<a id="schemastreamcontent"></a> <a id="schema_StreamContent"></a> <a id="tocSstreamcontent"></a> <a id="tocsstreamcontent"></a>
...
<a id="schemamapobject"></a> <a id="schema_MapObject"></a> <a id="tocSmapobject"></a> <a id="tocsmapobject"></a>
...
<a id="schemaserverresponsestring"></a> <a id="schema_ServerResponseString"></a> <a id="tocSserverresponsestring"></a> <a id="tocsserverresponsestring"></a>
...
<a id="schemaajaxresultlong"></a> <a id="schema_AjaxResultLong"></a> <a id="tocSajaxresultlong"></a> <a id="tocsajaxresultlong"></a>
...
<a id="schemaonstreamchangedhookparam"></a> <a id="schema_OnStreamChangedHookParam"></a> <a id="tocSonstreamchangedhookparam"></a> <a id="tocsonstreamchangedhookparam"></a>
...
<a id="schemaextendinforeq"></a> <a id="schema_ExtendInfoReq"></a> <a id="tocSextendinforeq"></a> <a id="tocsextendinforeq"></a>
...
<a id="schemahookresultforstreamnonereader"></a> <a id="schema_HookResultForStreamNoneReader"></a> <a id="tocShookresultforstreamnonereader"></a> <a id="tocshookresultforstreamnonereader"></a>
...
<a id="schemaserverresponseobject"></a> <a id="schema_ServerResponseObject"></a> <a id="tocSserverresponseobject"></a> <a id="tocsserverresponseobject"></a>
...
<a id="schemaonstreamnonereaderhookparam"></a> <a id="schema_OnStreamNoneReaderHookParam"></a> <a id="tocSonstreamnonereaderhookparam"></a> <a id="tocsonstreamnonereaderhookparam"></a>
...
<a id="schemadevicechannelcreatereq"></a> <a id="schema_DeviceChannelCreateReq"></a> <a id="tocSdevicechannelcreatereq"></a> <a id="tocsdevicechannelcreatereq"></a>
...
<a id="schemaextendinforeq1"></a> <a id="schema_ExtendInfoReq1"></a> <a id="tocSextendinforeq1"></a> <a id="tocsextendinforeq1"></a>
...
<a id="schemamediaplayer"></a> <a id="schema_MediaPlayer"></a> <a id="tocSmediaplayer"></a> <a id="tocsmediaplayer"></a>
...
<a id="schemaonstreamnotfoundhookparam"></a> <a id="schema_OnStreamNotFoundHookParam"></a> <a id="tocSonstreamnotfoundhookparam"></a> <a id="tocsonstreamnotfoundhookparam"></a>
...
<a id="schematrack"></a> <a id="schema_Track"></a> <a id="tocStrack"></a> <a id="tocstrack"></a>
...
<a id="schemadevicechannelupdatereq"></a> <a id="schema_DeviceChannelUpdateReq"></a> <a id="tocSdevicechannelupdatereq"></a> <a id="tocsdevicechannelupdatereq"></a>
...
<a id="schemamediadata"></a> <a id="schema_MediaData"></a> <a id="tocSmediadata"></a> <a id="tocsmediadata"></a>
...
<a id="schemahookparam"></a> <a id="schema_HookParam"></a> <a id="tocShookparam"></a> <a id="tocshookparam"></a>
...
<a id="schemaajaxresultdevicechannelvo"></a> <a id="schema_AjaxResultDeviceChannelVO"></a> <a id="tocSajaxresultdevicechannelvo"></a> <a id="tocsajaxresultdevicechannelvo"></a>
...
<a id="schemaserverresponselistmediadata"></a> <a id="schema_ServerResponseListMediaData"></a> <a id="tocSserverresponselistmediadata"></a> <a id="tocsserverresponselistmediadata"></a>
...
<a id="schemaonsendrtpstoppedhookparam"></a> <a id="schema_OnSendRtpStoppedHookParam"></a> <a id="tocSonsendrtpstoppedhookparam"></a> <a id="tocsonsendrtpstoppedhookparam"></a>
...
<a id="schemadevicechannelqueryreq"></a> <a id="schema_DeviceChannelQueryReq"></a> <a id="tocSdevicechannelqueryreq"></a> <a id="tocsdevicechannelqueryreq"></a>
...
<a id="schemamediareq"></a> <a id="schema_MediaReq"></a> <a id="tocSmediareq"></a> <a id="tocsmediareq"></a>
...
| vhost  | string | false | none |        | 筛选虚拟主机，例如**defaultVhost** |
...
<a id="schemaonrtpservertimeouthookparam"></a> <a id="schema_OnRtpServerTimeoutHookParam"></a> <a id="tocSonrtpservertimeouthookparam"></a> <a id="tocsonrtpservertimeouthookparam"></a>
...
<a id="schemaajaxresultvoid"></a> <a id="schema_AjaxResultVoid"></a> <a id="tocSajaxresultvoid"></a> <a id="tocsajaxresultvoid"></a>
...
<a id="schema"></a> <a id="schema_"></a> <a id="tocS"></a> <a id="tocs"></a>
...
<a id="schemahookresultforonhttpaccess"></a> <a id="schema_HookResultForOnHttpAccess"></a> <a id="tocShookresultforonhttpaccess"></a> <a id="tocshookresultforonhttpaccess"></a>
...
<a id="schemaajaxresultdevicechannellistresp"></a> <a id="schema_AjaxResultDeviceChannelListResp"></a> <a id="tocSajaxresultdevicechannellistresp"></a> <a id="tocsajaxresultdevicechannellistresp"></a>
...
<a id="schemaserverresponse"></a> <a id="schema_ServerResponse"></a> <a id="tocSserverresponse"></a> <a id="tocsserverresponse"></a>
...
<a id="schemaajaxresultboolean"></a> <a id="schema_AjaxResultBoolean"></a> <a id="tocSajaxresultboolean"></a> <a id="tocsajaxresultboolean"></a>
...
<a id="schemaonhttpaccessparam"></a> <a id="schema_OnHttpAccessParam"></a> <a id="tocSonhttpaccessparam"></a> <a id="tocsonhttpaccessparam"></a>
...
<a id="schemaclosestreamsreq"></a> <a id="schema_CloseStreamsReq"></a> <a id="tocSclosestreamsreq"></a> <a id="tocsclosestreamsreq"></a>
...
<a id="schemahookresultforonrtsprealm"></a> <a id="schema_HookResultForOnRtspRealm"></a> <a id="tocShookresultforonrtsprealm"></a> <a id="tocshookresultforonrtsprealm"></a>
...
<a id="schemaajaxresultstring"></a> <a id="schema_AjaxResultString"></a> <a id="tocSajaxresultstring"></a> <a id="tocsajaxresultstring"></a>
...
<a id="schemamediaonlinestatus"></a> <a id="schema_MediaOnlineStatus"></a> <a id="tocSmediaonlinestatus"></a> <a id="tocsmediaonlinestatus"></a>
...
<a id="schemaonrtsprealmhookparam"></a> <a id="schema_OnRtspRealmHookParam"></a> <a id="tocSonrtsprealmhookparam"></a> <a id="tocsonrtsprealmhookparam"></a>
...
<a id="schemaexporttaskcreatereq"></a> <a id="schema_ExportTaskCreateReq"></a> <a id="tocSexporttaskcreatereq"></a> <a id="tocsexporttaskcreatereq"></a>
...
<a id="schemaserverresponsemediaplayer"></a> <a id="schema_ServerResponseMediaPlayer"></a> <a id="tocSserverresponsemediaplayer"></a> <a id="tocsserverresponsemediaplayer"></a>
...
<a id="schemahookresultforonrtspauth"></a> <a id="schema_HookResultForOnRtspAuth"></a> <a id="tocShookresultforonrtspauth"></a> <a id="tocshookresultforonrtspauth"></a>
...
<a id="schemaexporttaskupdatereq"></a> <a id="schema_ExportTaskUpdateReq"></a> <a id="tocSexporttaskupdatereq"></a> <a id="tocsexporttaskupdatereq"></a>
...
<a id="schematrack2"></a> <a id="schema_Track2"></a> <a id="tocStrack2"></a> <a id="tocstrack2"></a>
...
<a id="schemaonrtspauthhookparam"></a> <a id="schema_OnRtspAuthHookParam"></a> <a id="tocSonrtspauthhookparam"></a> <a id="tocsonrtspauthhookparam"></a>
...
<a id="schemaextendinforeq3"></a> <a id="schema_ExtendInfoReq3"></a> <a id="tocSextendinforeq3"></a> <a id="tocsextendinforeq3"></a>
...
<a id="schemadevicecreatereq"></a> <a id="schema_DeviceCreateReq"></a> <a id="tocSdevicecreatereq"></a> <a id="tocsdevicecreatereq"></a>
...
<a id="schemaonflowreporthookparam"></a> <a id="schema_OnFlowReportHookParam"></a> <a id="tocSonflowreporthookparam"></a> <a id="tocsonflowreporthookparam"></a>
...
<a id="schemaoriginsock"></a> <a id="schema_OriginSock"></a> <a id="tocSoriginsock"></a> <a id="tocsoriginsock"></a>
...
<a id="schemamediainfo"></a> <a id="schema_MediaInfo"></a> <a id="tocSmediainfo"></a> <a id="tocsmediainfo"></a>
...
<a id="schemaonrecordmp4hookparam"></a> <a id="schema_OnRecordMp4HookParam"></a> <a id="tocSonrecordmp4hookparam"></a> <a id="tocsonrecordmp4hookparam"></a>
...
<a id="schemaextendinforeq4"></a> <a id="schema_ExtendInfoReq4"></a> <a id="tocSextendinforeq4"></a> <a id="tocsextendinforeq4"></a>
...
<a id="schemadeviceupdatereq"></a> <a id="schema_DeviceUpdateReq"></a> <a id="tocSdeviceupdatereq"></a> <a id="tocsdeviceupdatereq"></a>
...
<a id="schemaserverresponsemediainfo"></a> <a id="schema_ServerResponseMediaInfo"></a> <a id="tocSserverresponsemediainfo"></a> <a id="tocsserverresponsemediainfo"></a>
...
<a id="schemamapstring"></a> <a id="schema_MapString"></a> <a id="tocSmapstring"></a> <a id="tocsmapstring"></a>
...
<a id="schemaplayurl"></a> <a id="schema_PlayUrl"></a> <a id="tocSplayurl"></a> <a id="tocsplayurl"></a>
...
<a id="schemaserverresponseplayurl"></a> <a id="schema_ServerResponsePlayUrl"></a> <a id="tocSserverresponseplayurl"></a> <a id="tocsserverresponseplayurl"></a>
...
<a id="schemaajaxresultalarmlistresp"></a> <a id="schema_AjaxResultAlarmListResp"></a> <a id="tocSajaxresultalarmlistresp"></a> <a id="tocsajaxresultalarmlistresp"></a>
...
<a id="schematcplink"></a> <a id="schema_TcpLink"></a> <a id="tocStcplink"></a> <a id="tocstcplink"></a>
...
<a id="schemaalarmqueryreq"></a> <a id="schema_AlarmQueryReq"></a> <a id="tocSalarmqueryreq"></a> <a id="tocsalarmqueryreq"></a>
...
<a id="schemaserverresponselisttcplink"></a> <a id="schema_ServerResponseListTcpLink"></a> <a id="tocSserverresponselisttcplink"></a> <a id="tocsserverresponselisttcplink"></a>
...
<a id="schemaajaxresultalarmvo"></a> <a id="schema_AjaxResultAlarmVO"></a> <a id="tocSajaxresultalarmvo"></a> <a id="tocsajaxresultalarmvo"></a>
...
<a id="schemastreamkey"></a> <a id="schema_StreamKey"></a> <a id="tocSstreamkey"></a> <a id="tocsstreamkey"></a>
...
<a id="schemamaplong"></a> <a id="schema_MapLong"></a> <a id="tocSmaplong"></a> <a id="tocsmaplong"></a>
...
<a id="schemaserverresponsestreamkey"></a> <a id="schema_ServerResponseStreamKey"></a> <a id="tocSserverresponsestreamkey"></a> <a id="tocsserverresponsestreamkey"></a>
...
<a id="schemaajaxresultuserinfovo"></a> <a id="schema_AjaxResultUserInfoVO"></a> <a id="tocSajaxresultuserinfovo"></a> <a id="tocsajaxresultuserinfovo"></a>
...
<a id="schemastreamproxyitem"></a> <a id="schema_StreamProxyItem"></a> <a id="tocSstreamproxyitem"></a> <a id="tocsstreamproxyitem"></a>
...
| 名称 | 类型 | 必选 | 约束 | 中文名 | 说明 |
| --- | --- | --- | --- | --- | --- |
| vhost | string | false | none |  | 添加的流的虚拟主机，例如**defaultVhost** |
...
<a id="schemaajaxresultuserlistresp"></a> <a id="schema_AjaxResultUserListResp"></a> <a id="tocSajaxresultuserlistresp"></a> <a id="tocsajaxresultuserlistresp"></a>
...
<a id="schemastringdelflag"></a> <a id="schema_StringDelFlag"></a> <a id="tocSstringdelflag"></a> <a id="tocsstringdelflag"></a>
...
<a id="schemaajaxresultuservo"></a> <a id="schema_AjaxResultUserVO"></a> <a id="tocSajaxresultuservo"></a> <a id="tocsajaxresultuservo"></a>
...
<a id="schemaserverresponsestringdelflag"></a> <a id="schema_ServerResponseStringDelFlag"></a> <a id="tocSserverresponsestringdelflag"></a> <a id="tocsserverresponsestringdelflag"></a>
...
<a id="schemausercreatereq"></a> <a id="schema_UserCreateReq"></a> <a id="tocSusercreatereq"></a> <a id="tocsusercreatereq"></a>
...
<a id="schemastreampusheritem"></a> <a id="schema_StreamPusherItem"></a> <a id="tocSstreampusheritem"></a> <a id="tocsstreampusheritem"></a>
...
<a id="schemauserupdatereq"></a> <a id="schema_UserUpdateReq"></a> <a id="tocSuserupdatereq"></a> <a id="tocsuserupdatereq"></a>
...
<a id="schemastreamffmpegitem"></a> <a id="schema_StreamFfmpegItem"></a> <a id="tocSstreamffmpegitem"></a> <a id="tocsstreamffmpegitem"></a>
...
<a id="schemaajaxresultrolelistresp"></a> <a id="schema_AjaxResultRoleListResp"></a> <a id="tocSajaxresultrolelistresp"></a> <a id="tocsajaxresultrolelistresp"></a>
...
<a id="schemamp4recordfile"></a> <a id="schema_Mp4RecordFile"></a> <a id="tocSmp4recordfile"></a> <a id="tocsmp4recordfile"></a>
...
<a id="schemaajaxresultrolevo"></a> <a id="schema_AjaxResultRoleVO"></a> <a id="tocSajaxresultrolevo"></a> <a id="tocsajaxresultrolevo"></a>
...
<a id="schemaserverresponsemp4recordfile"></a> <a id="schema_ServerResponseMp4RecordFile"></a> <a id="tocSserverresponsemp4recordfile"></a> <a id="tocsserverresponsemp4recordfile"></a>
...
<a id="schemarolecreatereq"></a> <a id="schema_RoleCreateReq"></a> <a id="tocSrolecreatereq"></a> <a id="tocsrolecreatereq"></a>
...
<a id="schemarecordreq"></a> <a id="schema_RecordReq"></a> <a id="tocSrecordreq"></a> <a id="tocsrecordreq"></a>
...
<a id="schemaroleupdatereq"></a> <a id="schema_RoleUpdateReq"></a> <a id="tocSroleupdatereq"></a> <a id="tocsroleupdatereq"></a>
...
<a id="schemadeleterecorddirectory"></a> <a id="schema_DeleteRecordDirectory"></a> <a id="tocSdeleterecorddirectory"></a> <a id="tocsdeleterecorddirectory"></a>
...
<a id="schemaajaxresultlistmenuresp"></a> <a id="schema_AjaxResultListMenuResp"></a> <a id="tocSajaxresultlistmenuresp"></a> <a id="tocsajaxresultlistmenuresp"></a>
...
<a id="schemasnapshotreq"></a> <a id="schema_SnapshotReq"></a> <a id="tocSsnapshotreq"></a> <a id="tocssnapshotreq"></a>
...
<a id="schemaajaxresultlistmenuvo"></a> <a id="schema_AjaxResultListMenuVO"></a> <a id="tocSajaxresultlistmenuvo"></a> <a id="tocsajaxresultlistmenuvo"></a>
...
<a id="schemartpinforesult"></a> <a id="schema_RtpInfoResult"></a> <a id="tocSrtpinforesult"></a> <a id="tocsrtpinforesult"></a>
...
<a id="schemametareq"></a> <a id="schema_MetaReq"></a> <a id="tocSmetareq"></a> <a id="tocsmetareq"></a>
...
<a id="schemaopenrtpserverresult"></a> <a id="schema_OpenRtpServerResult"></a> <a id="tocSopenrtpserverresult"></a> <a id="tocsopenrtpserverresult"></a>
...
<a id="schemamenureq"></a> <a id="schema_MenuReq"></a> <a id="tocSmenureq"></a> <a id="tocsmenureq"></a>
...
<a id="schemaopenrtpserverreq"></a> <a id="schema_OpenRtpServerReq"></a> <a id="tocSopenrtpserverreq"></a> <a id="tocsopenrtpserverreq"></a>
...
<a id="schemaajaxresultliveplayvo"></a> <a id="schema_AjaxResultLivePlayVO"></a> <a id="tocSajaxresultliveplayvo"></a> <a id="tocsajaxresultliveplayvo"></a>
...
<a id="schemaconnectrtpserverreq"></a> <a id="schema_ConnectRtpServerReq"></a> <a id="tocSconnectrtpserverreq"></a> <a id="tocsconnectrtpserverreq"></a>
...
<a id="schemalivestartreq"></a> <a id="schema_LiveStartReq"></a> <a id="tocSlivestartreq"></a> <a id="tocslivestartreq"></a>
...
<a id="schemaclosertpserverresult"></a> <a id="schema_CloseRtpServerResult"></a> <a id="tocSclosertpserverresult"></a> <a id="tocsclosertpserverresult"></a>
...
<a id="schemalivestopreq"></a> <a id="schema_LiveStopReq"></a> <a id="tocSlivestopreq"></a> <a id="tocslivestopreq"></a>
...
<a id="schemartpserver"></a> <a id="schema_RtpServer"></a> <a id="tocSrtpserver"></a> <a id="tocsrtpserver"></a>
...
<a id="schemaajaxresultlistliveplayvo"></a> <a id="schema_AjaxResultListLivePlayVO"></a> <a id="tocSajaxresultlistliveplayvo"></a> <a id="tocsajaxresultlistliveplayvo"></a>
...
<a id="schemaserverresponselistrtpserver"></a> <a id="schema_ServerResponseListRtpServer"></a> <a id="tocSserverresponselistrtpserver"></a> <a id="tocsserverresponselistrtpserver"></a>
...
<a id="schemastartsendrtpresult"></a> <a id="schema_StartSendRtpResult"></a> <a id="tocSstartsendrtpresult"></a> <a id="tocsstartsendrtpresult"></a>
...
<a id="schemaplaybackstartreq"></a> <a id="schema_PlaybackStartReq"></a> <a id="tocSplaybackstartreq"></a> <a id="tocsplaybackstartreq"></a>
...
<a id="schemastartsendrtpreq"></a> <a id="schema_StartSendRtpReq"></a> <a id="tocSstartsendrtpreq"></a> <a id="tocsstartsendrtpreq"></a>
...
<a id="schemaplaybackcontrolreq"></a> <a id="schema_PlaybackControlReq"></a> <a id="tocSplaybackcontrolreq"></a> <a id="tocsplaybackcontrolreq"></a>
...
<a id="schemaclosesendrtpreq"></a> <a id="schema_CloseSendRtpReq"></a> <a id="tocSclosesendrtpreq"></a> <a id="tocsclosesendrtpreq"></a>
...
<a id="schemarecordqueryreq"></a> <a id="schema_RecordQueryReq"></a> <a id="tocSrecordqueryreq"></a> <a id="tocsrecordqueryreq"></a>
...
<a id="schemazlmnode"></a> <a id="schema_ZlmNode"></a> <a id="tocSzlmnode"></a> <a id="tocszlmnode"></a>
...
<a id="schemaajaxresultlistdeptresp"></a> <a id="schema_AjaxResultListDeptResp"></a> <a id="tocSajaxresultlistdeptresp"></a> <a id="tocsajaxresultlistdeptresp"></a>
...
<a id="schemadeptreq"></a> <a id="schema_DeptReq"></a> <a id="tocSdeptreq"></a> <a id="tocsdeptreq"></a>
...
<a id="schemaajaxresultloginresp"></a> <a id="schema_AjaxResultLoginResp"></a> <a id="tocSajaxresultloginresp"></a> <a id="tocsajaxresultloginresp"></a>
...
<a id="schemaloginreq"></a> <a id="schema_LoginReq"></a> <a id="tocSloginreq"></a> <a id="tocsloginreq"></a>
...
<a id="schemaajaxresultpushproxyvo"></a> <a id="schema_AjaxResultPushProxyVO"></a> <a id="tocSajaxresultpushproxyvo"></a> <a id="tocsajaxresultpushproxyvo"></a>
...
<a id="schemapushproxyextendreq"></a> <a id="schema_PushProxyExtendReq"></a> <a id="tocSpushproxyextendreq"></a> <a id="tocspushproxyextendreq"></a>
...
<a id="schemapushproxycreatereq"></a> <a id="schema_PushProxyCreateReq"></a> <a id="tocSpushproxycreatereq"></a> <a id="tocspushproxycreatereq"></a>
...
<a id="schemapushproxyupdatereq"></a> <a id="schema_PushProxyUpdateReq"></a> <a id="tocSpushproxyupdatereq"></a> <a id="tocspushproxyupdatereq"></a>
...
<a id="schemapushproxyqueryreq"></a> <a id="schema_PushProxyQueryReq"></a> <a id="tocSpushproxyqueryreq"></a> <a id="tocspushproxyqueryreq"></a>
...
<a id="schemaajaxresultpushproxylistresp"></a> <a id="schema_AjaxResultPushProxyListResp"></a> <a id="tocSajaxresultpushproxylistresp"></a> <a id="tocsajaxresultpushproxylistresp"></a>
...
<a id="schemaajaxresultstreamproxyvo"></a> <a id="schema_AjaxResultStreamProxyVO"></a> <a id="tocSajaxresultstreamproxyvo"></a> <a id="tocsajaxresultstreamproxyvo"></a>
...
<a id="schemastreamproxyextendreq"></a> <a id="schema_StreamProxyExtendReq"></a> <a id="tocSstreamproxyextendreq"></a> <a id="tocsstreamproxyextendreq"></a>
...
<a id="schemastreamproxycreatereq"></a> <a id="schema_StreamProxyCreateReq"></a> <a id="tocSstreamproxycreatereq"></a> <a id="tocsstreamproxycreatereq"></a>
...
<a id="schemastreamproxyupdatereq"></a> <a id="schema_StreamProxyUpdateReq"></a> <a id="tocSstreamproxyupdatereq"></a> <a id="tocsstreamproxyupdatereq"></a>
...
<a id="schemastreamproxyqueryreq"></a> <a id="schema_StreamProxyQueryReq"></a> <a id="tocSstreamproxyqueryreq"></a> <a id="tocsstreamproxyqueryreq"></a>
...
<a id="schemaajaxresultstreamproxylistresp"></a> <a id="schema_AjaxResultStreamProxyListResp"></a> <a id="tocSajaxresultstreamproxylistresp"></a> <a id="tocsajaxresultstreamproxylistresp"></a>
...
<a id="schemahandler"></a> <a id="schema_Handler"></a> <a id="tocShandler"></a> <a id="tocshandler"></a>
...
<a id="schemamediatype"></a> <a id="schema_MediaType"></a> <a id="tocSmediatype"></a> <a id="tocsmediatype"></a>
...
<a id="schemadatawithmediatype"></a> <a id="schema_DataWithMediaType"></a> <a id="tocSdatawithmediatype"></a> <a id="tocsdatawithmediatype"></a>
...
<a id="schemathrowable"></a> <a id="schema_Throwable"></a> <a id="tocSthrowable"></a> <a id="tocsthrowable"></a>
...
<a id="schemastacktraceelement"></a> <a id="schema_StackTraceElement"></a> <a id="tocSstacktraceelement"></a> <a id="tocsstacktraceelement"></a>
...
<a id="schemarunnable"></a> <a id="schema_Runnable"></a> <a id="tocSrunnable"></a> <a id="tocsrunnable"></a>
...
<a id="schemadefaultcallback"></a> <a id="schema_DefaultCallback"></a> <a id="tocSdefaultcallback"></a> <a id="tocsdefaultcallback"></a>
...
<a id="schemaerrorcallback"></a> <a id="schema_ErrorCallback"></a> <a id="tocSerrorcallback"></a> <a id="tocserrorcallback"></a>
...
<a id="schemasseemitter"></a> <a id="schema_SseEmitter"></a> <a id="tocSsseemitter"></a> <a id="tocssseemitter"></a>
...
<a id="schemaptzcontrolreq"></a> <a id="schema_PtzControlReq"></a> <a id="tocSptzcontrolreq"></a> <a id="tocsptzcontrolreq"></a>
...
<a id="schemaptzstopreq"></a> <a id="schema_PtzStopReq"></a> <a id="tocSptzstopreq"></a> <a id="tocsptzstopreq"></a>
...
<a id="schemapresetreq"></a> <a id="schema_PresetReq"></a> <a id="tocSpresetreq"></a> <a id="tocspresetreq"></a>
...
<h2 id="tocS_LabRegisterReq">LabRegisterReq</h2>

<a id="schemalabregisterreq"></a> <a id="schema_LabRegisterReq"></a> <a id="tocSlabregisterreq"></a> <a id="tocslabregisterreq"></a>
...
<h2 id="tocS_LabKeepaliveAutoReq">LabKeepaliveAutoReq</h2>

<a id="schemalabkeepaliveautoreq"></a> <a id="schema_LabKeepaliveAutoReq"></a> <a id="tocSlabkeepaliveautoreq"></a> <a id="tocslabkeepaliveautoreq"></a>
...
| 名称 | 类型 | 必选 | 约束 | 中文名 | 说明 |
| --- | --- | --- | --- | --- | --- |
| enabled | boolean | false | none |  | true 启用周期心跳，false 关闭 |
| intervalSec | integer | false | none |  | 心跳间隔（秒）；≤0 时后端回落默认 30s |

<h2 id="tocS_LabCatalogPushReq">LabCatalogPushReq</h2>

<a id="schemalabcatalogpushreq"></a> <a id="schema_LabCatalogPushReq"></a> <a id="tocSlabcatalogpushreq"></a> <a id="tocslabcatalogpushreq"></a>
...
| 名称         | 类型    | 必选  | 约束 | 中文名 | 说明 |
| ------------ | ------- | ----- | ---- | ------ | ---- |
| channelCount | integer | false | none |        | none |
| catalogName  | string  | false | none |        | none |

<h2 id="tocS_LabDeviceInfoPushReq">LabDeviceInfoPushReq</h2>

<a id="schemalabdeviceinfopushreq"></a> <a id="schema_LabDeviceInfoPushReq"></a> <a id="tocSlabdeviceinfopushreq"></a> <a id="tocslabdeviceinfopushreq"></a>
...
| firmware     | string | false | none |        | none |

<h2 id="tocS_LabAlarmPushReq">LabAlarmPushReq</h2>

<a id="schemalabalarmpushreq"></a> <a id="schema_LabAlarmPushReq"></a> <a id="tocSlabalarmpushreq"></a> <a id="tocslabalarmpushreq"></a>
